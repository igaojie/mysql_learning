...
Pages flushed up to 14160558584    //页中最大LSN刷新的数字
Last checkpoint at  14160558575   //当前mysql实例全局LSN刷新到的位置
...
| OLDEST_MODIFICATION | bigint(21) unsigned | NO   |     | 0       |       |---该页第一次被更新的时候的LSN
